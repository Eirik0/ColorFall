...
public class GameGridTest {
	...
	public void testDropOneColumn() {
		...
		grid.placeColumn(new FallingColumn(grid, 1, 2, 3, 0, 0), true);
		// 3
		// 2
		// 1
	...
	public void testDropTwoColumn() {
		GameGrid grid = new GameGrid();
		grid.placeColumn(new FallingColumn(grid, 1, 2, 3, 0, 0), true);
		grid.placeColumn(new FallingColumn(grid, 4, 5, 6, 0, 0), true);
		// 6
		// 5
		// 4
		// 3
	...
	public void testDropThreeOfTheSame() {
		GameGrid grid = new GameGrid();
		grid.placeColumn(new FallingColumn(grid, 1, 1, 1, 0, 0), true);
		// 1
		// 1
		// 1
	...
	public void testClearHorizontal() {
		GameGrid grid = new GameGrid();
		grid.placeColumn(new FallingColumn(grid, 1, 2, 3, 0, 0), true);
		grid.placeColumn(new FallingColumn(grid, 1, 4, 5, 1, 0), true);

		List<UpdateEntity> updates = grid.placeColumn(new FallingColumn(grid, 1, 6, 7, 2, 0), true);
	...
	public void testClearDiagonalRight() {
		GameGrid grid = new GameGrid();
		grid.placeColumn(new FallingColumn(grid, 2, 3, 1, 0, 0), true);
		grid.placeColumn(new FallingColumn(grid, 4, 1, 5, 1, 0), true);
		grid.placeColumn(new FallingColumn(grid, 1, 6, 7, 2, 0), true);
		// 1 5 7
		// 3 1 6
		// 2 4 1
		assertEquals(2, grid.get(0, GameGrid.HEIGHT - 1));
	...
	public void testClearDiagonalLeft() {
		...
		grid.placeColumn(new FallingColumn(grid, 1, 2, 3, 0, 0), true);
		grid.placeColumn(new FallingColumn(grid, 4, 1, 5, 1, 0), true);
		grid.placeColumn(new FallingColumn(grid, 6, 7, 1, 2, 0), true);
		// 3 5 1
		// 2 1 7
		// 1 4 6
		assertEquals(2, grid.get(0, GameGrid.HEIGHT - 1));
	...
	public void testClearTwoInOneColumn() {
		GameGrid grid = new GameGrid();
		grid.placeColumn(new FallingColumn(grid, 1, 2, 3, 0, 0), true);
		grid.placeColumn(new FallingColumn(grid, 4, 1, 5, 0, 0), true);
		grid.placeColumn(new FallingColumn(grid, 6, 1, 7, 1, 0), true);
		grid.placeColumn(new FallingColumn(grid, 1, 8, 9, 1, 0), true);
		grid.placeColumn(new FallingColumn(grid, 9, 9, 1, 2, 0), true);
		// 5 9
		// 1 8
		// 4 1
		// 3 7 1
	...
	public void testCombo() {
		GameGrid grid = new GameGrid();
		grid.placeColumn(new FallingColumn(grid, 2, 5, 1, 2, 0), true);
		grid.placeColumn(new FallingColumn(grid, 2, 1, 4, 1, 0), true);
		List<UpdateEntity> updates = grid.placeColumn(new FallingColumn(grid, 1, 2, 3, 0, 0), true);
